"use strict";
  ...
  const GUIDE_HTML = `
    ...
    <div class="legend">
      ...
      🦘 撑杆(快·跳过第一株) / 🏈 橄榄球(快·投掷橄榄球远程砸植物) / 🦣 巨人(一拳碎植物·死亡爆炸) / 🐴 巨人骑兵(5倍血·较快) / 🚙 装甲车BOSS(20倍血·车顶坐巨人·同屏最多2个) /
      🕷️ 空降蜘蛛(偷植物·只落右侧4列) / 🎈 气球(飞行·需仙人掌/炸弹) / 🦅 狮鹫骑士(强大空中僵尸·高血·需对空/爆炸) / 🚪 铁门(挡豌豆·用火焰/爆炸破) / 🛡️ 盾牌巨人(免疫豌豆·盾牌只能被仙人掌穿刺打破·但怕辣椒/炸弹) / 🦔 盾穿山甲(地底潜行不可攻击·最多钻到第5格出土·厚甲高防御)<br>
      <b>Boss</b>：🌀 鸣人(120波后·能量极光穿透整行·高血高伤·出场8秒无敌且免疫冰冻·同屏最多2) / 🚙 装甲车(150波后·超高血·装甲格挡穿甲子弹·尖刺无法穿透) / 🧙 女巫(80波后·每5秒给周围僵尸+500%血2秒)<br>
      <b>终极技能</b>：🌻终极向日葵(攻速流)每10秒触发⚡狂暴·本行攻速+100%持续4秒 / 🌻终极向日葵(血量流)每10秒给本行植物回血20% · 🥔终极土豆盾(Lv10)蓄力满后身上出现护盾图标·点击释放给本行植物套上闪电护盾2秒无敌(可切换手动/自动·自动模式会智能格挡鸣人激光) ·❄️终极寒冰(Lv5)每20秒冰霜雪雨·全屏冻结5秒<br>
    ...
    <p style="font-size:14px">🌻 <b>第 5 波后点击向日葵升级</b>，二选一分支(费用线性递增 250/500/750/1000/1250)：⚡攻速(满级本行攻速翻倍) 或 🛡血量(每级 +50% 本行血量)；
       ...
       🥔 土豆盾 / ❄️ 寒冰 也可点击升级。<br>
       👑 <b>向日葵融合</b>：同一流派(攻速/血量)拥有 <b>5 棵终极向日葵</b>时，头顶出现"可融合"提示，点击其一消耗 <b>10000 阳光</b>融合为<b>王冠向日葵</b>——10倍生命值与阳光产量，对应技能(狂暴/回血)变为<b>全屏</b>。<br>
       ❄️ <b>王冠寒冰</b>(5棵满级寒冰融合)：冰霜雪雨期间<b>持续按最大血量造成共10%伤害</b>，可触发融化。<br>
       🌿 <b>王冠三豆</b>(5棵满级三豆融合)：技能<b>撒豆成兵</b>——每10秒从天降下最多5个<b>巨型点燃豌豆火球</b>，对目标造成大量伤害。</p>`;
