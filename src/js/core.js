"use strict";
  ...
  const GUIDE_HTML = `
    ...
    <div class="legend">
      ...
      🔁 <b>双发射手</b> 双倍火力 · 🌿 <b>三豆射手</b> 连发3颗(50波解锁) · 🌵 <b>仙人掌</b> 穿透尖刺(贯穿整行·后方有僵尸会向后射击) · 🌵 <b>巨仙掌</b> 穿透尖刺·可打空中·克制气球(10波解锁·可升级到Lv10·每级加攻速·Lv10解锁地刺每20秒在目标格钻出巨型地刺·击退2格·可把潜行穿山甲撞出地面) · 🔥 <b>篝火</b> 豌豆附魔火焰·穿铁门(10波解锁·50波后可升级·每级加火伤·Lv5点燃僵尸灼伤5秒·点燃弹击中冰冻僵尸触发融化·伤害+200%) ·
      ...
      🦘 撑杆(快·跳过第一株) / 🏈 橄榄球 / 🦣 巨人(一拳碎植物·死亡爆炸) / 🐴 巨人骑兵(5倍血·较快) / 🚙 装甲车BOSS(20倍血·车顶坐巨人·同屏最多2个) /
      🕷️ 空降蜘蛛(偷植物·只落右侧4列) / 🎈 气球(飞行·需仙人掌/炸弹) / 🦅 狮鹫骑士(强大空中僵尸·高血·需对空/爆炸) / 🚪 铁门(挡豌豆·用火焰/爆炸破) / 🛡️ 盾牌巨人(免疫豌豆/爆炸·盾牌只能被仙人掌穿刺打破·破盾后才可击杀) / 🦔 盾穿山甲(地底潜行不可攻击·最多钻到第5格出土·厚甲高防御)<br>
      <b>Boss</b>：🌀 鸣人(120波后·能量极光穿透整行·高血高伤·同屏最多2) / 🚙 装甲车(150波后·超高血) / 🧙 女巫(80波后·每5秒给周围僵尸+500%血2秒)<br>
      <b>终极技能</b>：🌻终极向日葵(攻速流)每10秒触发⚡狂暴·本行攻速+100%持续4秒 / 🌻终极向日葵(血量流)每10秒给本行植物回血20% · 🥔终极土豆盾(Lv10)蓄力满后身上出现护盾图标·点击释放给本行植物套上闪电护盾2秒无敌(可切换手动/自动) ·❄️终极寒冰(Lv5)每20秒冰霜雪雨·全屏冻结5秒<br>
