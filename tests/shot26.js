...
const A=global.__API; A.start(); A.setWave(20);
A.addPlant('cactus',1,1); A.addPlant('bigcactus',3,1);
A.addZombie('balloon',3); A.zombies&&0;
...
if(raf)raf(t);
fs.writeFileSync('preview26.png', real.toBuffer('image/png'));
console.log('done');
